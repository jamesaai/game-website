...
const DepartmentCard = ({ department, index }: { department: Department; index: number }) => {
  ...
  return (
    <div
      ref={cardRef}
      className="bg-gray-800 rounded-lg shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/30"
    ...
    >
      <img
        ...
        onError={(e) => {
          ...
          target.src = `data:image/svg+xml,%3Csvg width='400' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Crect fill='%23374151' width='400' height='200'/%3E%3Ctext fill='%23fff' font-size='20' x='50%25' y='50%25' text-anchor='middle' dy='.3em'%3E${department.icon}%3C/text%3E%3C/svg%3E`;
        }}
      />
      <div className="p-6">
  ...
  return (
    <section id="staff" ref={sectionRef} className="min-h-screen bg-gray-900 text-white">
      <div className="container mx-auto px-4 sm:px-6 py-20">
        {/* Back to Home Link */}
        <Link to="/" className="text-blue-400 hover:underline mb-8 inline-block transition-colors">
          &lt; Back to Home
        </Link>
        ...
        <div className="text-center bg-gray-800 rounded-lg p-8 sm:p-12">
