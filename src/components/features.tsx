...
```
      <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
        Explore authentic fire alarm systems, from pull stations to control panels. 
        Experience realistic fire drills and emergency scenarios in our detailed simulation.
      </p>
    </div>
      ...
      <BentoTilt className="bento-tilt_2">
        <div className="flex size-full flex-col justify-between bg-red-600 p-5">
          <h1 className="bento-title special-font max-w-64 text-white">
            M<b>o</b>re syste<b>m</b>s co<b>m</b>ing!
          </h1>
